 ...
 * </p>
 * <ul>
 *   <li>{@link metamodeloNewsletter.impl.TableImpl#getRows <em>Rows</em>}</li>
 *   <li>{@link metamodeloNewsletter.impl.TableImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link metamodeloNewsletter.impl.TableImpl#getBackgroundColor <em>Background Color</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TableImpl extends MinimalEObjectImpl.Container implements Table {
	...
	protected EClass eStaticClass() {
		return MetamodeloNewsletterPackage.Literals.TABLE;
	}
	...
	public EList<Row> getRows() {
		if (rows == null) {
			rows = new EObjectContainmentEList<Row>(Row.class, this, MetamodeloNewsletterPackage.TABLE__ROWS);
		}
		return rows;
	}
	...
	public void setBackgroundColor(Color newBackgroundColor) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodeloNewsletterPackage.TABLE__BACKGROUND_COLOR, oldBackgroundColor, backgroundColor));
	}

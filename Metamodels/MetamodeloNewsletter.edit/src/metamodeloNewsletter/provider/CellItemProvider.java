...
/**
 * This is the item provider adapter for a {@link metamodeloNewsletter.Cell} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class CellItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cell_width_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cell_width_feature", "_UI_Cell_type"),
				 MetamodeloNewsletterPackage.Literals.CELL__WIDTH,
				 true,
				 false,
				 false,
	...
	protected void addBackgroundColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cell_backgroundColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cell_backgroundColor_feature", "_UI_Cell_type"),
				 MetamodeloNewsletterPackage.Literals.CELL__BACKGROUND_COLOR,
				 true,
				 false,
				 false,
	...
	protected void addVerticalAlignmentPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Cell_verticalAlignment_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Cell_verticalAlignment_feature", "_UI_Cell_type"),
				 MetamodeloNewsletterPackage.Literals.CELL__VERTICAL_ALIGNMENT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetamodeloNewsletterPackage.Literals.CELL__ELEMENTS,
		...
		newChildDescriptors.add
			(createChildParameter
				(MetamodeloNewsletterPackage.Literals.CELL__ELEMENTS,
				 MetamodeloNewsletterFactory.eINSTANCE.createImage()));

		newChildDescriptors.add
			(createChildParameter
				(MetamodeloNewsletterPackage.Literals.CELL__ELEMENTS,
				 MetamodeloNewsletterFactory.eINSTANCE.createVideo()));

		newChildDescriptors.add
			(createChildParameter
				(MetamodeloNewsletterPackage.Literals.CELL__ELEMENTS,
				 MetamodeloNewsletterFactory.eINSTANCE.createDivider()));
	}
	...
	public ResourceLocator getResourceLocator() {
		return NewsletterEditPlugin.INSTANCE;
	}

...
/**
 * This is the item provider adapter for a {@link metamodeloNewsletter.Video} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VideoItemProvider extends ElementItemProvider {
	/**
	...
	public String getText(Object object) {
		String label = ((Video)object).getLink();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetamodeloNewsletterPackage.Literals.VIDEO__PREVIEW,
				 MetamodeloNewsletterFactory.eINSTANCE.createImage()));

		newChildDescriptors.add
			(createChildParameter
				(MetamodeloNewsletterPackage.Literals.VIDEO__TITLE,

...
/**
 * This is the item provider adapter for a {@link metamodeloNewsletter.Element} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ElementItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_link_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_link_feature", "_UI_Element_type"),
				 MetamodeloNewsletterPackage.Literals.ELEMENT__LINK,
				 true,
				 false,
				 false,
	...
	protected void addWidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_width_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_width_feature", "_UI_Element_type"),
				 MetamodeloNewsletterPackage.Literals.ELEMENT__WIDTH,
				 true,
				 false,
				 false,
	...
	protected void addHeightPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Element_height_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Element_height_feature", "_UI_Element_type"),
				 MetamodeloNewsletterPackage.Literals.ELEMENT__HEIGHT,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Element)object).getLink();

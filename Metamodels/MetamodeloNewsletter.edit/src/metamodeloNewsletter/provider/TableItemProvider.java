...
/**
 * This is the item provider adapter for a {@link metamodeloNewsletter.Table} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class TableItemProvider 
	...
	protected void addBackgroundColorPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Table_backgroundColor_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Table_backgroundColor_feature", "_UI_Table_type"),
				 MetamodeloNewsletterPackage.Literals.TABLE__BACKGROUND_COLOR,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(MetamodeloNewsletterPackage.Literals.TABLE__ROWS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(MetamodeloNewsletterPackage.Literals.TABLE__ROWS,
				 MetamodeloNewsletterFactory.eINSTANCE.createRow()));
	}
